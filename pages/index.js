  ...
  return (
    <div className={styles.appContainer}>
      <Head>
        ...
        ></link>
        <link
          href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@700&family=Abril+Fatface&display=swap"
          rel="stylesheet"
        ></link>
        <link
      ...
      <div className={`flexCentCol ${styles.nameBox}`}>
        <h1 style={{ zIndex: '3' }}>Kris Bertolino</h1>
        <div className={`flexCent ${styles.tagLine}`}>
          <h4
            style={{
              color: 'black',
