  ...
  return (
    <div className={`flexCent ${styles.contactContainer}`}>
      <div className={styles.elipImage}>
        <h1 style={{ width: '100%', margin: '0px' }}>I&apos;m Kris.</h1>
        <div className={`flexCent ${styles.intro}`}>
          <h2
            style={{
        ...
        <div className={styles.infoAndBio}>
          <div
            className={`flexCenCol ${styles.contact}`}
            style={{
              'font-family': 'Goudy Old Style, sans-serif',
              fontWeight: '800',
            }}
          ...
          >
            Born and raised in Delaware County, I moved to the city of Philadelphia
            to study Computer Science in 2010. I crashed and burned and 
            went on to work a ton of different jobs. Some I loved, some not so much, 
            and though I gained a ton of life experience, I never found anything I was quite
            passionate about.<br/><br/>
            I reapproached Web Development during the pandemic and was hooked. After
            several months of studying full time I joined a bootcamp. Now, roughly
            two years after starting I am working to make a career out of it.
          </div>
        </div>
      </div>
    </div>
